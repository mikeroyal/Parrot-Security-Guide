...
1. [Getting Started](https://github.com/mikeroyal/Parrot-Security-Guide#getting-started)

2. [Getting Software](https://github.com/mikeroyal/Parrot-Security-Guide#getting-software)

3. [Gaming](https://github.com/mikeroyal/Parrot-Security-Guide#gaming)

4. [Game Development](https://github.com/mikeroyal/Parrot-Security-Guide#game-development)

5. [Setting up a macOS Workspace](https://github.com/mikeroyal/Parrot-Security-Guide#setting-up-a-macos-workspace)

6. [Setting up a Windows 10 Workspace](https://github.com/mikeroyal/Parrot-Security-Guide#setting-up-a-windows-10-workspace)

7. [Using Android and Android Apps on Linux](https://github.com/mikeroyal/Parrot-Security-Guide#using-android-and-android-apps-on-linux)

8. [Professional Audio/Video Editing](https://github.com/mikeroyal/Parrot-Security-Guide#professional-audio--video-editing)

9. [Kubernetes](https://github.com/mikeroyal/Parrot-Security-Guide#kubernetes)

10. [Machine Learning](https://github.com/mikeroyal/Parrot-Security-Guide#machine-learning)

11. [Robotics](https://github.com/mikeroyal/Parrot-Security-Guide#robotics)

12. [Open Source Security](https://github.com/mikeroyal/Parrot-Security-Guide#open-source-security)

13. [Differential Privacy](https://github.com/mikeroyal/Parrot-Security-Guide#differential-privacy)

14. [Cloud Native Development](https://github.com/mikeroyal/Parrot-Security-Guide#cloud-native-development)
...
[Parrot Security OS](https://www.parrotsec.org/) is an open-source, Debian-based Linux distribution geared towards various information security tasks, such as Penetration Testing, Security Research, Computer Forensics, Reverse Engineering, and Cryptography. It comes with MATE as the default desktop environment and is developed by Frozenbox Team.

[Parrot Security Edition](https://parrotsec.org/security-edition) is a special purpose operating system designed for Penetration Test and Red Team operations. It contains a full arsenal of ready to use pentest tools.

[Parrot Home Edition](https://parrotsec.org/home-edition) is a general purpose operating system with the typical Parrot look and feel. This edition is designed for daily use, privacy and software development. Parrot Tools can be manually installed to assemble a custom and lightweight pentesting environment.

[Parrot IoT and Cloud Appliances](https://parrotsec.org/virtual) are special editions of Parrot Security made for embedded devices, cloud environments, virtual machines and other special deployments.

[Parrot Security Documentation](https://www.parrotsec.org/docs)

[Parrot Security GitHub](https://github.com/ParrotSec)

[Community Forum](https://www.parrotsec.org/#community)

[Parrot Security Team](https://www.parrotsec.org/team)

[Donate to the Parrot Security project](https://www.parrotsec.org)
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Parrot-Security-Guide/pulls).
